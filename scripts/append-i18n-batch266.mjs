...
const extra = [
  ["firma.directorPh", L("Geschäftsführer", "Managing director", "Genel müdür", "المدير التنفيذي", "Gérant", "Gerente", "Amministratore", "Dyrektor")],
  ["firma.bankPh", L("Bankname", "Bank name", "Banka adı", "اسم البنك", "Banque", "Banco", "Banca", "Bank")],
];
