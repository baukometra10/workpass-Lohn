...
export function platformCapabilities() {
  return {
    ...
    notes: [
      ...
      "Show delivery.title / documentTitle / description in the employee inbox and Antrag using envelope.locale (de/en/tr/ar/fr/es/it/pl). German originals on *De fields. Never raw codes or ‘Fehlende Unterlagen’.",
