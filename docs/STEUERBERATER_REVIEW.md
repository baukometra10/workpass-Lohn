...
5. ELSTER: LStA (Firma, Monat) und LStB-XML (Mitarbeiter, Jahr) gegen Summen; Zertifikat/PIN.
...
- `GET /v1/portal/lsta` / `POST /v1/portal/lsta-submit` – Lohnsteueranmeldung der Firma (Monat)
